        ...
        private void LoadProduct()
        {
            ...
            if (p != null)
            {
                if (p.Bvin != string.Empty)
                {
                    ...
                    this.WeightField.Text = Math.Round(p.ShippingDetails.Weight, 3, MerchantTribeApplication.Current.CurrentStore.Settings.MidpointRoundingMode).ToString();
                    this.LengthField.Text = Math.Round(p.ShippingDetails.Length, 3, MerchantTribeApplication.Current.CurrentStore.Settings.MidpointRoundingMode).ToString();
                    this.WidthField.Text = Math.Round(p.ShippingDetails.Width, 3, MerchantTribeApplication.Current.CurrentStore.Settings.MidpointRoundingMode).ToString();
                    this.HeightField.Text = Math.Round(p.ShippingDetails.Height, 3, MerchantTribeApplication.Current.CurrentStore.Settings.MidpointRoundingMode).ToString();
                    ...
                    this.MinimumQtyField.Text = Math.Round((decimal)p.MinimumQty, 0, MerchantTribeApplication.Current.CurrentStore.Settings.MidpointRoundingMode).ToString();
